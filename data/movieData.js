...
export const findMovieById = (movieId) => {
    const findMovie = movieData.find(m => m.id === parseInt(movieId));
    return findMovie;
}
...
export const findMovieIndex = (movieId) => {
    const findMovie = movieData.findIndex((movie) => {
...
// console.log(movieData[findMovieIndex(1049948)])